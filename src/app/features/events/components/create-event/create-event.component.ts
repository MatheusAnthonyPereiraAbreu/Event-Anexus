...
export class CreateEventComponent {
    ...
    onSubmit() {
        ...
        const formValue = this.eventForm.getRawValue(); // getRawValue pega valores de campos desabilitados também
        const eventData: CreateEventDto = {
            ...
            type: formValue.type,
            speaker: formValue.speaker || undefined,
        ...
        this.eventsService.createEvent(eventData).subscribe({
            next: (response) => {
                ...
                this.modalService.success(
                    'Evento criado!',
                    'O evento foi cadastrado com sucesso e está visível para inscrições.'
                ).subscribe(() => {
